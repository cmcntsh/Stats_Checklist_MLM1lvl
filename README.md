...
| IV:<br><br>DV:<br><br>For multi-level models:<br><br>Will a random intercept be present?<br><br>Will random slopes be present?<br><br>Model to be fit, including the fixed effects in the model and random effects in the model:<br><br> |
